...
type Props = RootStackScreenProps<'GameplayScreenGame3Player1'>;

export default function GameplayScreenGame3Player1({ navigation, route }: Props) {
    ...
    <SafeAreaView style={styles.container}>
      ...
      {__DEV__ && (
        <View style={styles.devScreenIndicator}>
          <Text style={styles.devScreenText}>GameplayScreenGame3Player1</Text>
        </View>
      )}
