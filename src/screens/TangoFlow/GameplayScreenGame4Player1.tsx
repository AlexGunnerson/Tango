...
type Props = RootStackScreenProps<'GameplayScreenGame4Player1'>;

export default function GameplayScreenGame4Player1({ navigation, route }: Props) {
    ...
    <SafeAreaView style={styles.container}>
      ...
      {__DEV__ && (
        <View style={styles.devScreenIndicator}>
          <Text style={styles.devScreenText}>GameplayScreenGame4Player1</Text>
        </View>
      )}
